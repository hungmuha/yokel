...
var AspenComponent = (function () {
    function AspenComponent() {
        this.locations = [
            {
                city: "Aspen",
                state: "CO"
    ...
    AspenComponent.prototype.dismissNav = function () {
        this.navExpanded = false;
    };
    AspenComponent.prototype.toggleNav = function () {
        console.log("YAyyyy");
        if (!this.navExpanded) {
    ...
    AspenComponent.prototype.ngOnInit = function () {
    };
    return AspenComponent;
}());
AspenComponent.decorators = [
    { type: core_1.Component, args: [{
                selector: 'aspen',
                templateUrl: './aspen.component.html',
                styleUrls: ['./aspen.component.css']
            },] },
];
/** @nocollapse */
AspenComponent.ctorParameters = function () { return []; };
exports.AspenComponent = AspenComponent;
//# sourceMappingURL=aspen.component.js.map